 ...
 */
class NotEmptyOperation extends \TYPO3\Eel\FlowQuery\Operations\AbstractOperation  {
	 ...
	 * @var string
	 */
	static protected $shortName = 'notEmpty';
	...
	public function evaluate(\TYPO3\Eel\FlowQuery\FlowQuery $flowQuery, array $arguments) {
		if (count($arguments) == 0) {
			...
			$flowQuery->pushOperation('notEmpty', array());
