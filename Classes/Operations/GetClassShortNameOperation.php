 ...
 */
class GetClassShortNameOperation extends \TYPO3\Eel\FlowQuery\Operations\AbstractOperation {
	 ...
	 * @var string
	 */
	static protected $shortName = 'getClassShortName';
	...
	public function evaluate(\TYPO3\Eel\FlowQuery\FlowQuery $flowQuery, array $arguments) {
		if (count($arguments) == 0) {
			...
			$parts = preg_match('/[^\\\\]*$/', $className,  $match);
