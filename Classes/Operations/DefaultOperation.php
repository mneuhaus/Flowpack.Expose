 ...
 */
class DefaultOperation extends \TYPO3\Eel\FlowQuery\Operations\AbstractOperation  {
	 ...
	 * @var string
	 */
	static protected $shortName = 'default';
	...
	public function evaluate(\TYPO3\Eel\FlowQuery\FlowQuery $flowQuery, array $arguments) {
		if (count($arguments) == 1) {
			...
			return empty($value[0]) ? $arguments[0] : $value[0];
		} else {
