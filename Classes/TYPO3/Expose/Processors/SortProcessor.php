...
class SortProcessor extends AbstractProcessor {
	...
	public function wrap($content, $arguments) {
		...
		$this->viewHelperVariableContainer->add('TYPO3\Expose\ViewHelpers\Query\SortViewHelper', 'sorting', $this->sorting);
		$content =  $this->viewHelperVariableContainer->getView()->renderPartial('SortField', NULL, $arguments);
		$this->viewHelperVariableContainer->remove('TYPO3\Expose\ViewHelpers\Query\SortViewHelper', 'sorting');
		return $content;
	}
}
