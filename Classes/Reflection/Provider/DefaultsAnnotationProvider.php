...
class DefaultsAnnotationProvider extends AbstractAnnotationProvider {
	...
	public function getClassAnnotations($class){
		$defaults = $this->configurationManager->getConfiguration(\TYPO3\FLOW3\Configuration\ConfigurationManager::CONFIGURATION_TYPE_SETTINGS, "Foo.ContentManagement.Defaults");
