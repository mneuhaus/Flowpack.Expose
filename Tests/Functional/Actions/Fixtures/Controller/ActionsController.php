<?php
namespace Foo\ContentManagement\Tests\Functional\Actions\Fixtures\Controller;
...
class ActionsController extends \TYPO3\FLOW3\Mvc\Controller\ActionController {
	...
	public function setTemplate($action) {
		$this->view->setTemplatePathAndFilename("Packages/Application/Foo.ContentManagement/Tests/Functional/Actions/Fixtures/Templates/" . $action . ".html");
	}
